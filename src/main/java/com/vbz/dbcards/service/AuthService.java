...
public class AuthService {
    ...
    @Autowired
    private PendingShareService pendingShareService;
    ...
    public Map<String,Object> loginVerifyOtp(
        ...
        // Claim any cards shared before the receiver joined DBC
        pendingShareService.claimPendingShares(
                user.getUserId(), user.getMobileNumber());
